  ...
  return (
    <div className="min-h-screen flex flex-col bg-white text-[#333333]">
      ...
      <main className="flex-1 w-full">
        {/* Hero Section */}
        <section className="relative w-full bg-[#002D72] text-white py-16 sm:py-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center">
            ...
            <h1 className="font-serif text-3xl sm:text-5xl font-normal mb-6">
              Pusat Informasi Kesehatan Shilah
            </h1>
            <p className="text-base sm:text-lg text-white/90 max-w-2xl mx-auto font-light leading-relaxed mb-8">
            ...
            {/* Search Box */}
            <div className="max-w-xl mx-auto flex items-center bg-white rounded-lg p-2 shadow-lg">
              ...
              />
              <button className="px-6 py-2.5 bg-[#0077C8] hover:bg-[#005fa3] text-white text-sm font-medium rounded-md transition-colors">
                Cari
              </button>
            </div>
          </div>
